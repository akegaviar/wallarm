...
=================================
Установите с использованием NGINX
=================================
...
* специальная сборка NGINX: :command:`<path to nginx>/nginx -v`
...
необходимо сначала установить его. :ref:`installation-linux-ru`.
...
Обратитесь к `официальной инструкции по установке NGINX <https://www.nginx.com/resources/admin-guide/installing-nginx-open-source/>`_.
...
``/etc/wallarm/triggers.d/nginx`` измените команду перезапуска, указав новую
после приведенного ниже фрагмента:
