...
Данная инструкция предполагает, что у вас установлен
`NGINX официальной сборки <http://nginx.org/en/linux_packages.html>`__.

Если вы используете специальную сборку NGINX, обратитесь к
разделу :ref:`installation-nginx-ru`.
